...
{
    public Text qText; //text refrence for question text
    public Text aText; //text refrence for button a text
    public Text bText; //text refrence for button b text
    public Text cText; // text refrence for button c text
